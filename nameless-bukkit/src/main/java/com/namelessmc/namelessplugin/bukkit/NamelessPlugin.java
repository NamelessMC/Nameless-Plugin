package com.namelessmc.namelessplugin.bukkit;
...
import com.namelessmc.namelessplugin.bukkit.commands.GetNotificationsCommand;
import com.namelessmc.namelessplugin.bukkit.commands.GetUserCommand;
import com.namelessmc.namelessplugin.bukkit.commands.RegisterCommand;
import com.namelessmc.namelessplugin.bukkit.commands.ReportCommand;
import com.namelessmc.namelessplugin.bukkit.commands.SetGroupCommand;
import com.namelessmc.namelessplugin.bukkit.mcstats.Metrics;
import com.namelessmc.namelessplugin.bukkit.player.PlayerEventListener;
import com.namelessmc.namelessplugin.bukkit.utils.MessagesUtil;
	...
	public void userCheck(Player player){
		...
		if(!yFile.contains(player.getUniqueId().toString())){
			...
			try {
				...
				getLogger().info(ChatColor.translateAlternateColorCodes('&',"&cCould not add &a" + player.getName() + " &cto the Player Information File!"));
				e.printStackTrace();
			}
		}
