 ...
 * Original Source: Sponge
 * Line 280 edited by NamelessMC
 */
public final class NamelessCommandSpec implements CommandCallable {
    ...
    NamelessCommandSpec(CommandElement args, CommandExecutor executor, @Nullable Text description, @Nullable Text extendedDescription,
    ...
    public static final class Builder {
        ...
        /**
         * Create a new {@link NamelessCommandSpec} based on the data provided in this
         * builder.
         *
         * @return the new spec
         */
        public NamelessCommandSpec build() {
            if (this.childCommandMap == null) {
            ...
            return new NamelessCommandSpec(this.args, this.executor, this.description, this.extendedDescription, this.permission,
                    this.argumentParser);
        }
    }
    ...
    public void checkPermission(CommandSource source) throws CommandException {
        ...
        if (!testPermission(source)) {
            throw new CommandPermissionException(Message.NO_PERMISSION.getMessage());
        }
    }
    ...
    public boolean equals(@Nullable Object o) {
        ...
        NamelessCommandSpec that = (NamelessCommandSpec) o;
