...
public class RequestUtil {
	...
	public String getAlerts(Player player) throws Exception {
		String toPostString = "uuid=" + URLEncoder.encode(player.getName(), "UTF-8");
		...
		if(response.containsKey("error")){
			...
			alerts = message.get("alerts").toString();
		}
	...
	public String getPMs(Player player) throws Exception {
		String toPostString = "uuid=" + URLEncoder.encode(player.getName(), "UTF-8");
		...
		if(response.containsKey("error")){
			...
			messages = message.get("messages").toString();
		}
